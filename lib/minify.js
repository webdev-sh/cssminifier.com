...
var execCmd = '/home/chilts/src/chilts-cssminifier-com/node_modules/.bin/cleancss'
var execOpts = {
  timeout : 3 * 1000, // 3 seconds
  env : {
    PATH : "/home/chilts/.nvm/versions/node/v4.2.2/bin",
  },
}

// minify() swallows errors with the CSS, but returns errors with the program (reading or writing files)
function minify(flakeId, css, callback) {
  ...
  var orgFilename = libDir + '/' + flakeId + '.css'
  var minFilename = libDir + '/' + flakeId + '.min.css'
